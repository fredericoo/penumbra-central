...
function penumbra_register_widge2t() {
	register_widget( 'Penumbra_Imagem' );
}
add_action( 'widgets_init', 'penumbra_register_widget2' );

class Penumbra_Imagem extends WP_Widget_Media {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Image' ),
			array(
				'description' => __( 'Imagem + Lazyload.' ),
				'mime_type'   => 'image',
			)
		);
