	...
	function understrap_widgets_init() {
		...
		register_sidebar(
			array(
				...
				'id'            => 'footerfull',
				'description'   => __( 'Cada bloco equivale a uma coluna no rodapé', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="footer-widget %2$s col-lg-2 col-md-4 col-6">',
		...
		// register_sidebar(
		// 	array(
		// 		'name'          => __( 'Boletim semanal', 'understrap' ),
		// 		'id'            => 'boletim',
		// 		'description'   => __( 'Insira o conteúdo do boletim semanal aqui', 'understrap' ),
		// 		'before_widget' => '<div id="%1$s" class="boletim-semanal col-12 col-lg-6 col-md-8 mx-auto">',
		// 		'after_widget'  => '</div><!-- .footer-widget -->',
