...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-total"><?php esc_html_e( 'Total', 'understrap' ); ?></th>
			</tr>
		</thead>
		<tbody>
	...
	<div id="payment">
		...
		<div class="form-row">
			...
			<?php echo apply_filters( 'woocommerce_pay_order_button_html', '<button type="submit" class="btn btn-primary btn-block btn-lg link" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '">' . esc_html( $order_button_text ) . '</button>' ); // @codingStandardsIgnoreLine ?>
