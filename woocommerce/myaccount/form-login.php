...
<?php endif; ?>
		<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <text text-anchor="middle">
              <textPath startOffset="50%" class="font-sharp25 svgtext" xlink:href="#typepath">acesse sua conta</textPath>
            </text>
        </svg>
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<div class="form-check">
				<!-- <input class="form-checl-input woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever" /> <span><?php esc_html_e( 'Remember me', 'woocommerce' ); ?></span></input> -->
				<label class="form-check-label woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme"><label>
  			</div>

			<p class="form-row">

				<?php wp_nonce_field( 'woocommerce-login', 'woocommerce-login-nonce' ); ?>
				<button type="submit" class="btn btn-outline-primary btn-lg btn-block" name="login" value="<?php esc_attr_e( 'Log in', 'woocommerce' ); ?>"><?php esc_html_e( 'Log in', 'woocommerce' ); ?></button>
...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
	...
	<div class="col-md-6">
		...
		<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <text text-anchor="middle">
              <textPath startOffset="50%" class="font-sharp25 svgtext" xlink:href="#typepath">Cadastre-se</textPath>
            </text>
        </svg>
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<p class="woocommerce-FormRow form-row">
				...
				<button type="submit" class="btn btn-outline-primary btn-lg btn-block" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
			</p>
